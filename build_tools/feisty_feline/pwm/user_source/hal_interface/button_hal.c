...
static volatile int button_pressed_flag; 	// Holds whether ` not a RISING edge has been detected
...
static void button_gpio_init(void)
{
	...
	__HAL_RCC_GPIOF_CLK_ENABLE(); // Enable clock to GPIOF so PA0 works
...
{
	HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_6); 	// This function will first clear the IRQ on EXTI0
